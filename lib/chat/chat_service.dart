...
import 'package:unshelf_buyer/models/message.dart';
...
class ChatService extends ChangeNotifier {
  ...
  Future<void> sendMessage(String receiverId, String message) async {
    ...
    Message newMessage = Message(
        senderId: currentUserId, senderEmail: currentUserEmail, receiverId: receiverId, timestamp: timestamp, message: message);
